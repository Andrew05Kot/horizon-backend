...
public class BookingTouristSpecification implements Specification<BookingEntity> {

	private static final long serialVersionUID = 6780218411885895782L;
	private SearchCriteria searchCriteria;

	public BookingTouristSpecification(SearchCriteria searchCriteria) {
	...
	public boolean equals(Object o) {
		...
		BookingTouristSpecification that = (BookingTouristSpecification) o;
